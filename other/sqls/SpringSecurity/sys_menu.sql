...
CREATE TABLE `sys_menu`  (
  ...
  `create_by` bigint(0) DEFAULT NULL,
  `create_time` datetime(0) DEFAULT NULL,
  `update_by` bigint(0) DEFAULT NULL,
  `update_time` datetime(0) DEFAULT NULL,
  `del_flag` int(0) DEFAULT 0 COMMENT '是否删除（0未删除 1已删除）',
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, 'NULL', NULL, NULL, '0', '0', 'seata', '#', NULL, NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_menu` VALUES (2, 'NULL', NULL, NULL, '0', '0', 'hello', '#', NULL, NULL, NULL, NULL, 0, NULL);
...
CREATE TABLE `sys_role`  (
  ...
  `del_flag` int(0) DEFAULT 0 COMMENT 'del_flag',
  `create_by` bigint(0) DEFAULT NULL,
  `create_time` datetime(0) DEFAULT NULL,
  `update_by` bigint(0) DEFAULT NULL,
  `update_time` datetime(0) DEFAULT NULL,
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, NULL, 'admin', '0', 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role` VALUES (2, NULL, 'test', '0', 0, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `sys_user`  (
  ...
  `phonenumber` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '手机号',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'dftdla', 'NULL', '$2a$10$MDZrpwrZEd606EX9dRR3peWyGfOkOMxvb1OFQFCO5iGwRXjOuItDO', '0', NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_user` VALUES (2, 'ccxtest', 'NULL', '$2a$10$MDZrpwrZEd606EX9dRR3peWyGfOkOMxvb1OFQFCO5iGwRXjOuItDO', '0', NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_user` VALUES (3, 'ccx', 'NULL', 'NULL', '0', NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, 0);
